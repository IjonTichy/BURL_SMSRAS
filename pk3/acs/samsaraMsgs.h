...
int ClassPickupMessages[CLASSCOUNT][SLOTCOUNT][MSGCOUNT] = 
{
    ...
    },
    {
        ...
        {
            "Chainsaw! Assault rifle! We're rolling now!",
            "Throwing chainsaws: not actually a good idea, but who cares?",
            "Desire to have your guns, etc.",
            "The rumbling is actually just SOLIDIFIED ADRENALINE in your bloodstream. It also kills the pain!",
            "When you lower it, THEN everyone hears it. wat",
            "They fire invisible lasers.",
            "omg assault rifle cod ruined everything remove now",
            "Dammit, stop trying to put grenades into it!",
            "The previous model was not a chaingun, by the way.",
            "\caGAS POWERED SAW! NEVER RUNS OUTTA GAS!",
        },
        {
            "ur n gud shtor n cn fir BLLTS frm tny GN",
            "",
            "",
            "",
            "",
        ...
        {
            "You got the shotgun!",
            "Shooting straight through two imps with a shotgun is normal!",
            "Don't ask how that finish has stayed there.",
            "150 damage is perfectly reasonable for a shotgun.",
            "It pneumatically launches the shell. Why else would it launch enemies five miles?",
            "AHAHGHAGH I'M SO MAD I CAN PUMP MY SHOTGUN SLIGHTLY FASTER",
            "",
            "",
            "",
            "",
        ...
        {
            "You got the super shotgun!",
            "300 damage is perfectly reasonable for an SSG.",
            "Remember that other classes get buffed with this addon.",
            "Now with magical disappearing pellets!",
            "You could blind someone with the sheen on this thing.",
            "I shot a cacodemon with this once. I never saw that cacodemon again.",
            "Also good for assisted space travel.",
            "",
            "",
            "",
        },
        {
            "You got the chaingun!",
            "You got the broken perspective gun!",
            "Accuracy not included.",
            "Seriously, who cleans and polishes these damn things?!",
            "Man and I thought this was a sniper rifle.",
            "Why'd they throw in two more barrels?",
            "You'd think having a chaingun stuck in your chest would have at least a little recoil.",
            "",
            "",
            "",
        },
        {
            "You got the rocket launcher!",
            "It explodes! The explosions explode! We don't know why!",
            "They will fear your explosive extension ejaculations.",
            "I can't fill hallways with rockets this gun sux ;_;",
            "700 damage. One rocket. A bit much?",
            "a+ perfect balance in every way",
            "You'd think it'd let you jump really far, but no, it just blows you up. What a sham.",
            "",
            "",
            "",
        },
        {
            "You got the plasma rifle!",
            "It fires explosions! We still don't know why!",
            "Oh my god the plasma rotates this is so high tech oh gooooood",
            "Alt-fire still useless!",
            "And how does a berserk pack speed this thing up?",
            "The UAC has the weirdest sources of inspiration for weapon aesthetics.",
            "",
            "",
            "",
            "",
        ...
        {
            "You got the BFG9000! Oh, yes.",
            "Slap a trail on it and call it a day.",
            "Because plasma has the mass and inertia to barrel through enemies.",
            "It was originally a toaster from some big mountain.",
            "Clearly this is a stealth weapon.",
            "",
            "",
            "",
            "",
        ...
        },
        {
            ...
            "They fire invisible lasers.",
            "\caGAS POWERED SAW! NEVER RUNS OUTTA GAS!",
            "Oh my god this rips off Doom so much.",
            "",
            "",
        },
    },
...
int ClassUniqueMessages[CLASSCOUNT][MSGCOUNT] =
{
    ...
    {
        "You gulped down a berserkerer pack! You feel invulnerable!",
        "AGAHGHAGHAGHAG I'M SO MAD MY GUNS GET MAD TOO",
        "\caBRAVERY",
        "It even makes you forget charging spider masterminds is a bad idea!",
        "It's really just a giant IV bag of pure adrenaline in a box.",
        "Life expectancy minus 10 years at best.",
        "\cgJESUS SWORD POWERS ACTIVATE",
        "",
        "",
        "",
    },
...
// jesus fucking christ, 1300 lines
